...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        echo ""
        sleep 2
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(arch).tar.gz https://github.com/qiliy/3x-ui/releases/download/${last_version}/x-ui-linux-$(arch).tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/qiliy/3x-ui/releases/download/${last_version}/x-ui-linux-$(arch).tar.gz"
        echo ""
        echo -e "--------------------------------------------"
...
echo -e "----------------------------------------------"
echo ""
echo -e "${green}〔3X-UI〕优化版项目地址：${yellow}https://github.com/qiliy/3x-ui${plain}" 
echo ""
echo -e "${green} 详细安装教程：${yellow}https://qiliy.github.io/xufei/2024/05/3x-ui/${plain}"
echo ""
echo -e "----------------------------------------------"
echo ""
